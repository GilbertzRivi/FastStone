...
import net.oktawia.faststone.defs.FastRecipes;

import java.util.List;
import java.util.Map;
import java.util.function.Consumer;

public class FastRecipeProvider extends RecipeProvider implements IConditionBuilder {

    public FastRecipeProvider(PackOutput pOutput) {
        super(pOutput);
    }

    @Override
    protected void buildRecipes(Consumer<FinishedRecipe> writer) {
        FastRecipes.registerRecipes();

        for (var recipe : FastRecipes.getRecipes()) {
    ...
    private void save(Consumer<FinishedRecipe> writer, String id, String pattern,
        ...
        var recipeId = Faststone.makeId(id);
